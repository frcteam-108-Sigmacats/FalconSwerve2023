...
public class SwerveModule extends SubsystemBase {
  ...
  public SwerveModulePosition getPosition(){
    return new SwerveModulePosition(falconToMeters(driveMotor.getSelectedSensorPosition(), chassisConstants.circumference, chassisConstants.driveMotorGearRat), getTurnAngle());
  }
